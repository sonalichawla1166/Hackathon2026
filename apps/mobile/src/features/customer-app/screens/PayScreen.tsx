...
export function PayScreen() {
  ...
  const amount = (
    <View style={[styles.amountCard, desktop && styles.amountCardDesktop]}>
  ...
  // The desktop shape is the familiar checkout one: pick a method on the left,
  // with what you owe and the button to commit held together on the right.
  if (desktop) {
    return (
      <View style={[styles.wrap, styles.wrapDesktop]}>
        <View style={styles.columns}>
          <View style={[styles.column, styles.columnWide]}>{options}</View>
